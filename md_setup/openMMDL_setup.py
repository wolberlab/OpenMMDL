...
###########################################################################################################
    ...
    if ensemble == 'npt':
        if water != 'Implicit' and water != 'OBC' and water != 'GBn' and water != 'GBn2' and water != None:
...
with open(f'Equilibration_{protein}', 'w') as outfile:
    ...
    if session['rmsd'] == 'True':
            script.append("rmsd_for_atomgroups(f'prot_lig_top.pdb', f'prot_lig_traj.dcd', selection1='backbone', selection2=f'protein or resname UNK')")
