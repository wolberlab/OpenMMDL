...
import pytest
from openmmdl.openmmdl_analysis.barcodes import BarcodeGenerator, BarcodePlotter
...
def test_barcodegeneration(sample_dataframe_barcode_generation):
    ...
    barcode = generator.generate_barcode(interaction)
...
def test_plot_barcodes(sample_dataframe_barcode_generation):
    # create barcode data
...
def test_plot_waterbridge_piechart(tmp_path):
    ...
    # Call the function
    plotter.plot_waterbridge_piechart(
        waterbridge_barcodes, waterbridge_interactions, fig_type
    )
...
def test_plot_bacodes_grouped(tmp_path):
    ...
    working_directory = os.getcwd()
    plotter=BarcodePlotter(df_all)
    plotter.plot_barcodes_grouped(interactions, interaction_type, fig_type)
