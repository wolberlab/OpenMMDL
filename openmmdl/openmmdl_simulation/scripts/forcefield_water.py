...
class ForcefieldSelector:
    def __init__(self):
        ...
        self.old_amber = {"amber99sb.xml", "amber99sbildn.xml", "amber03.xml", "amber10.xml"}
    ...
    def water_forcefield_selection(self, water, forcefield_selection):
        ...
        if forcefield_selection in self.old_amber:
            ...
            water_model = self.water_forcefields.get(forcefield_selection, {}).get(water, None)
        return water_model
...
class ForcefieldGenerator:
    ...
    def generate_forcefield(self, protein_ff, solvent_ff, add_membrane, smallMoleculeForceField, rdkit_mol=None):
        """
    ...
    def generate_transitional_forcefield(self, protein_ff, solvent_ff, add_membrane, smallMoleculeForceField, rdkit_mol=None):
        """
