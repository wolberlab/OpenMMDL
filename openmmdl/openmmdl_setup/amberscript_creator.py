...
class AmberBashScriptWriter:
    ...
    Attributes:
        script (list): A list representing lines of the Amber bash script.
    ...
    def __init__(self, session, uploaded_files):
        ...
        Args:
            session (dict): Session-specific parameters and settings.
            uploaded_files (dict): Uploaded files organized by their respective types.
        """
        self.script = []
        self.amber_script = AmberScriptGenerator(session, uploaded_files)

    def write_amber_script(self):
        """
