...
def highlight_numbers(split_data, starting_idx):
    ...
    for item in split_data:
        ...
        if interaction_type == 'hbond':
            ...
            for code in numeric_codes:
                atom_index = int(code) - starting_idx  # Subtract starting_idx from the numeric code
                highlighted_saltbridge.append(atom_index)
    ...
    return highlighted_hbond_donor, highlighted_hbond_acceptor, highlighted_hbond_both, highlighted_hydrophobic, highlighted_waterbridge, highlighted_pistacking, highlighted_halogen, highlighted_saltbridge, highlighted_pication, highlighted_metal
